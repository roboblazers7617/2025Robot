...
#include "MIDIAbsoluteEncoderLooped.hpp"
 ...
 */
class CCAbsoluteEncoderLooped : public MIDIAbsoluteEncoderLooped<ContinuousCCSender> {
  public:
    /**
     * @brief   Construct a new CCAbsoluteEncoderLooped object with the given pins, 
     ...
     *          lower speed.
     */
    CCAbsoluteEncoderLooped(AHEncoder &&encoder, MIDIAddress address,
                      int16_t multiplier = 1, uint8_t pulsesPerStep = 4)
        : MIDIAbsoluteEncoderLooped<ContinuousCCSender>(
