...
class GenericMIDIAbsoluteEncoderLooped : public MIDIOutputElement {
  public:
    GenericMIDIAbsoluteEncoderLooped(Enc &&encoder, MIDIAddress address,
...
using MIDIAbsoluteEncoderLooped = GenericMIDIAbsoluteEncoderLooped<AHEncoder, Sender>;

template <class Sender>
using BorrowedMIDIAbsoluteEncoderLooped =
    GenericMIDIAbsoluteEncoderLooped<AHEncoder &, Sender>;
